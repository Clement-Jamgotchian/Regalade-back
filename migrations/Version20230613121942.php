 ...
 */
final class Version20230613121942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_list ADD portions INT DEFAULT NULL, DROP date');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE recipe_list ADD date DATE DEFAULT NULL, DROP portions');
        $this->addSql('ALTER TABLE diet_member DROP FOREIGN KEY FK_8C2DE2E8E1E13ACE');
        $this->addSql('ALTER TABLE diet_member DROP FOREIGN KEY FK_8C2DE2E87597D3FE');
